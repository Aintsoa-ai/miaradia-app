...
export default function SignUpScreen() {
  ...
  return (
    <KeyboardAwareScrollView
      ...
      contentContainerStyle={{ flexGrow: 1, alignItems: isDesktop ? 'center' : 'stretch', paddingBottom: 60 }}
    ...
    >
      ...
      <View style={{
        ...
        <Text style={{ color: 'white', fontSize: isDesktop ? 36 : 30, fontWeight: '900', letterSpacing: -0.5, marginBottom: 8 }}>
          Créez votre compte
        </Text>
      ...
      <View style={{ width: '100%', maxWidth: isDesktop ? 640 : '100%', paddingHorizontal: isDesktop ? 40 : 24, paddingTop: 20, paddingBottom: 8 }}>
        <TouchableOpacity
